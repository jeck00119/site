...
export default {
    ...
    setup() {
        ...
        const { currentComponent, componentLoading, componentsRetrieving, _, load,
        ...
        const { algorithmTypeId, algorithms, currentAlgorithm, algorithmAttributes, parameters,
            ...
            liveProcessAlgorithm, _2, _3 } = useAlgorithms(algorithmUid, currentReferenceId, currentImageSourceId, moduleName, graphicsObject, ipAddress, port);
        ...
        onBeforeUnmount(() => {
            ...
            store.dispatch("algorithms/setAlgorithmResult", null);
            store.dispatch("components/setIdentifications", []);
