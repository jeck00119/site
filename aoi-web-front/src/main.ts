...
import { faHouse, faMagnifyingGlassChart, faScrewdriverWrench, faGear, faGears, faUser,
    ...
    faCheckCircle, faTimesCircle, faExclamationTriangle, faInfoCircle, faPencilAlt, faEye, faSquare } from '@fortawesome/free-solid-svg-icons';
...
app.config.errorHandler = (err: unknown, instance: ComponentPublicInstance | null, info: string) => {
    ...
    console.error('Global Vue Error:', {
        ...
        component: (instance as any)?.$options?.name || (instance as any)?.type?.name || 'Unknown Component',
        errorInfo: info,
    ...
    if (instance && (instance as any).$store) {
        (instance as any).$store.dispatch('errors/addError', {
