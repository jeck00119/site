...
@router.get("")
@handle_route_errors("list", "ImageGenerator")
async def list_image_generators(
    ...
    return RouteHelper.transform_list_to_uid_name(generators)


@router.get("/{image_generator_uid}")
@handle_route_errors("retrieve", "ImageGenerator", "image_generator_uid")
async def get_image_generator(
    ...
    return ImageGeneratorModel(**res)


@router.post("")
@handle_route_errors("create", "ImageGenerator", success_status=201)
...
@handle_route_errors("update", "ImageGenerator", "image_generator_uid")
...
@handle_route_errors("delete", "ImageGenerator", "image_generator_uid")
...
@handle_route_errors("upload", "ImageGenerator")
