...
class ClipsShutAlgorithmModel(AlgorithmParametersModel):
    threshold: int = 127
    blur_kernel_size: int = 1
    blur_sigma: float = 0.00
    kernel_direction: str = "Horizontal"
    kernel_size: int = 1
    size_threshold: float = 0.00
    ...
    def get_ui_from_type(self):
        return self.load_ui_dictionary("services/algorithms/implementation/ui_objects/clips_shut.json")
