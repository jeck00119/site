...
class HorizontalLinePositionAlgorithmModel(AlgorithmParametersModel):
    binary_threshold: int = 0
    horizontal_start: int = 0
    horizontal_stop: int = 0
    ...
    def get_ui_from_type(self):
        return self.load_ui_dictionary("services/algorithms/implementation/ui_objects/horizontal_line.json")
