...
class BrightnessAveragingAlgorithmModel(AlgorithmParametersModel):
    bottom_threshold: int = 0
    upper_threshold: int = 0
    percentage_threshold: int = 50
    ...
    def get_ui_from_type(self):
        return self.load_ui_dictionary("services/algorithms/implementation/ui_objects/brightness_averaging.json")
